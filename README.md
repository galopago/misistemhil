...
### Build a test rig in 5 steps:

1.Board selection              |2.Position the boards on the backplate     |
-------------------------------|-------------------------------------------|
...
Misistemita is an open source project by [Galopago](https://galopago.github.io/)
